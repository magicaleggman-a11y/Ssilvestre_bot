...
const BOT_CODE_VERSION = 'v5-timezone-fix'; // cambiá esto en cada versión para poder confirmar con /version qué código está corriendo
...
bot.onText(/\/version/, (msg) => {
  ...
  bot.sendMessage(msg.chat.id, `🔖 Versión del código corriendo: \`${BOT_CODE_VERSION}\``, { parse_mode: 'Markdown' });
});
...
const TIMEZONE = process.env.TIMEZONE || 'America/Bogota'; // ver DEPLOY.md para tu zona horaria correcta
cron.schedule(
  `0 ${summaryHour} * * *`,
  () => {
